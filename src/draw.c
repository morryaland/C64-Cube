...
/* 0x20 + ((i & 0xF8) * 40) */
const unsigned int ylookup[] = {
_+32,_+352,_+672,_+992,_+1312,_+1632,_+1952,_+2272,_+2592,_+2912,_+3232,_+3552,_+3872,_+4192,_+4512,_+4832,_+5152,_+5472,_+5792,_+6112,_+6432,_+6752,_+7072,_+7392,_+7712
};
#endif
#undef _
...
#else
  ((char*)ylookup[y])[x & ~7] |= 0b11000000 >> (x & 6);
#endif
}
...
void triangle(char x1, char y1, char x2, char y2, char x3, char y3, char color)
{
  ...
  line(x3, y3, x1, y1);
#else
  char dx, dx2, dx3, dy, dy2, dy3, tmp, xl;
